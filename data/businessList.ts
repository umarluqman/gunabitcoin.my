...
export const businessList: Business[] = [
  ...
  },
  {
    title: "Shinjiru",
    tags: ["hosting"],
    description: `One stop centre for Domain Name extensions, Shared Hosting Solutions, VPS & Dedicated Server Hosting options.`,
    imgSrc: "/biz/shinjiru.webp",
    href: "https://www.shinjiru.com.my/",
    twitter: "https://x.com/ShinjiruHosting",
    type: "digital",
  },
  {
    title: "BolehVPN",
    tags: ["vpn"],
    description: `RECLAIM your security, privacy, and anonymity with our personal VPN.`,
    imgSrc: "/biz/bolehvpn.webp",
    href: "https://www.bolehvpn.net/",
    twitter: "https://x.com/bolehvpn",
    type: "digital",
  },
  {
    title: "Aperture",
    tags: ["restaurant"],
    description: `East Coast and Thai restaurant cafe in Taman Tun Dr. Ismail.`,
    imgSrc: "/biz/aperture.webp",
